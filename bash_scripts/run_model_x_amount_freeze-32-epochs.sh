...
# preprocessing
srun singularity exec /ceph/container/python/python_3.12.sif python src/preprocessing/main.py --config training_configs/BioLinkBert-large-freeze-16-epochs-out-of-32-epochs.yaml > logs/biolink-large-freeze-16-epochs-out-of-32-epochs-pre.out 2> logs/biolink-large-freeze-16-epochs-out-of-32-epochs-pre.err

# training
srun singularity exec --nv /ceph/container/python/python_3.12.sif python src/NER/training.py --config training_configs/BioLinkBert-large-freeze-16-epochs-out-of-32-epochs.yaml > logs/biolink-large-freeze-16-epochs-out-of-32-epochs-train.out 2> logs/biolink-large-freeze-16-epochs-out-of-32-epochs-train.err

# inference
srun singularity exec --nv /ceph/container/python/python_3.12.sif python src/NER/inference.py --config training_configs/BioLinkBert-large-freeze-16-epochs-out-of-32-epochs.yaml > logs/biolink-large-freeze-16-epochs-out-of-32-epochs-inf.out 2> logs/biolink-large-freeze-16-epochs-out-of-32-epochs-inf.err
...
# training
srun singularity exec --nv /ceph/container/python/python_3.12.sif python src/NER/training.py --config training_configs/BioLinkBert-large-freeze-20-epochs-out-of-32-epochs.yaml > logs/biolink-large-freeze-20-epochs-out-of-32-epochs-train.out 2> logs/biolink-large-freeze-20-epochs-out-of-32-epochs-train.err

# inference
srun singularity exec --nv /ceph/container/python/python_3.12.sif python src/NER/inference.py --config training_configs/BioLinkBert-large-freeze-20-epochs-out-of-32-epochs.yaml > logs/biolink-large-freeze-20-epochs-out-of-32-epochs-inf.out 2> logs/biolink-large-freeze-20-epochs-out-of-32-epochs-inf.err
