#!/bin/bash
#SBATCH --job-name=biomedelectra-large-uncased-abstract
#SBATCH --output=biomedelectra-large-uncased-abstract.out
#SBATCH --error=biomedelectra-large-uncased-abstract.err
#SBATCH --mem=24G
