...
def load_and_combine_metadata_with_ner_results(ner_results_path, test_data_path):
	...
	save_json_data(combined_data, os.path.join("combined_data", "combined_ner_and_test_data_5.json"))
	...
	for filename in os.listdir(CONFIG_DIR):
		...
		if os.path.isfile(file_path):
			...
			re_inference = REInference(
				test_data_path=os.path.join("combined_data", "combined_ner_and_test_data_5.json"),
